const Pedido = ({icone, titulo, descricao}) => { //Terceira refatoração props
    // const icone = props.icone *Primeira refatoração props
    // const titulo = props.titulo
    // const descricao = props.descricao
    // const {icone, titulo, descricao} = props *Segunda refatoração props
      return (
